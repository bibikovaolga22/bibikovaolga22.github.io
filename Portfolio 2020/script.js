...
// four.firstElementChild.nextElementSibling.style.width = "21.5em";
...
work.addEventListener("click", function(event)  {
  ...
  four.style.display = "flex";
  four.style.justifyContent = "center";
  overlay1.firstElementChild.nextElementSibling.firstElementChild.firstElementChild.nextElementSibling.style.width = "100%"
...
//  three.style.height = "100px";
//   wrapper.style.gridAutoRows =  "100px 100px auto" ;
//   }  
//  }
